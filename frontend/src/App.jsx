      ...
      <div className="screen anim-screen">
        <div className="landingWrap">
          <div className="landingInner landingInnerNarrow">
            {status === "done" ? (
              <>
                <h2 className="heroTitle anim-heroTitle">Your edited audio is ready.</h2>
                <p className="heroSub anim-heroSub">{message || "Done!"}</p>

                <div className="card anim-card" style={{ marginTop: 18 }}>
                  {outputUrl && (
                    <>
              ...
              <>
                <h2 className="heroTitle anim-heroTitle">Something went wrong.</h2>
                <p className="heroSub anim-heroSub">{error || "Unknown error"}</p>
